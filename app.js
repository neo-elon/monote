...
function updateAuthUI(user) {
    ...
    if (user) {
        ...
        authContainer.innerHTML = `
            <button id="google-login-btn" class="btn-flat btn-sm google-login-btn" title="구글 로그인" style="display: flex; align-items: center; gap: 0.5rem; font-weight: 500; padding: 0.4rem 0.8rem;">
                <svg class="google-icon" viewBox="0 0 24 24" width="14" height="14" style="margin-right: 2px;">
